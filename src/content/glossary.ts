    ...
    terms: [
      {
        ...
        ar: {
          ...
          definition:
            "الضفة الغربية، بما فيها القدس الشرقية، وقطاع غزة: الأراضي التي تحتلها إسرائيل عسكريًا منذ حرب الأيام الستة عام 1967، تمييزًا لها عن إسرائيل ضمن حدودها قبل عام 1967.",
        },
      },
      {
        id: "green-line",
